...
import com.example.didonglin.testapplication.helper.AppConfig;
import com.example.didonglin.testapplication.helper.AppController;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    private void registerUser(final String name, final String email, final String password) {
        ...
        if (appController != null)
            appController.addToRequestQueue(stringRequest, tag_string_req);
        else
            Toast.makeText(getApplicationContext(), "ohhh, 现在服务器出错了！暂时无法注册！", Toast.LENGTH_SHORT).show();
    }
